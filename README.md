...
Open 4 browser tabs:
- **Admin Command Center:** http://localhost:3001 (login: dawit@fisheries.gov.et / admin123)
- **Fisher App:** http://localhost:3002 (375px width) — tesfaye@fisher.et / fisher123
- **Fish Market:** http://localhost:3003 — mesfin@buyer.et / buyer123
- Optional: run `npm run simulate:boats` after fisher starts a trip (see Phase 3)

**Step 1** — Admin: Confirm header shows **LIVE** (green) on Command Overview  
...
│   ├── src/
│   │   ├── database/         schema.sql, seed.js, reset.js
