...
async function main() {
  ...
  const zones = [
    {
      ...
      type: 'ALLOWED',
      description: 'Primary fishing zone near Gorgora.',
      gpsLat: 12.2167,
      gpsLng: 37.2833,
    },
    {
      ...
      type: 'ALLOWED',
      description: 'Active fisher community east of the lake.',
      gpsLat: 11.9167,
      gpsLng: 37.7,
    },
    {
      ...
      type: 'ALLOWED',
      description: 'High-volume zone near Bahir Dar city.',
      gpsLat: 11.5742,
      gpsLng: 37.3614,
    },
    {
      ...
      type: 'RESTRICTED',
      description: 'Seasonal restrictions apply.',
      gpsLat: 11.8,
      gpsLng: 37.05,
    },
    {
      ...
      type: 'RESTRICTED',
      description: 'Ecotourism overlap zone.',
      gpsLat: 11.6833,
      gpsLng: 37.3167,
    },
    {
      ...
      type: 'PROHIBITED',
      description: 'Breeding grounds — no fishing.',
      gpsLat: 11.95,
      gpsLng: 37.4,
    },
  ];
  ...
  const ziwayZones = [
    {
      name: 'Lake Ziway – North Shore',
      type: 'ALLOWED',
      description: 'Primary Ziway fishing area.',
      gpsLat: 7.88,
      gpsLng: 38.7,
    },
    {
      name: 'Lake Ziway – South Basin',
      type: 'ALLOWED',
      description: 'Active south basin.',
      gpsLat: 7.78,
      gpsLng: 38.73,
    },
    {
      name: 'Lake Ziway – Bird Island Buffer',
      type: 'RESTRICTED',
      description: 'Seasonal restrictions near bird habitat.',
      gpsLat: 7.85,
      gpsLng: 38.68,
    },
  ];
  const hawassaZones = [
    {
      name: 'Lake Hawassa – Resort Bay',
      type: 'ALLOWED',
      description: 'Main Hawassa fishing zone.',
      gpsLat: 7.06,
      gpsLng: 38.47,
    },
    {
      name: 'Lake Hawassa – East Shore',
      type: 'ALLOWED',
      description: 'East shore community zone.',
      gpsLat: 7.04,
      gpsLng: 38.5,
    },
    {
      name: 'Lake Hawassa – Protected Wetland',
      type: 'RESTRICTED',
      description: 'Reduced catch limits.',
      gpsLat: 7.08,
      gpsLng: 38.44,
    },
  ];
  ...
  const adminUsers = [
    ...
    {
      name: 'Tigist Haile',
      email: 'tigist@fisheries.gov.et',
      role: 'admin',
      phone: '+251922345678',
    },
    {
      name: 'Yonas Tadesse',
      email: 'yonas@fisheries.gov.et',
      role: 'admin',
      phone: '+251933456789',
    },
    {
      name: 'Mekdes Alemu',
      email: 'mekdes@fisheries.gov.et',
      role: 'admin',
      phone: '+251944567890',
    },
    {
  ...
  const otherLakeFishers = [
    {
      name: 'Chala Bekele',
      email: 'chala@ziway.fisher.et',
      phone: '+251911200001',
      license: 'FSH-ZWY-2024-001',
      status: 'VALID',
      expiry: '2026-12-31',
      zone: 'Lake Ziway – North Shore',
      boat: 'Ziway Star',
      reg: 'ZW-2024-001',
      cap: 180,
      region: 'ZIWAY',
    ...
    {
      name: 'Desta Lemma',
      email: 'desta@ziway.fisher.et',
      phone: '+251911200002',
      license: 'FSH-ZWY-2024-002',
      status: 'VALID',
      expiry: '2026-11-30',
      zone: 'Lake Ziway – South Basin',
      boat: 'Oromia Dawn',
      reg: 'ZW-2024-002',
      cap: 160,
      region: 'ZIWAY',
    ...
    {
      name: 'Hirut Tadesse',
      email: 'hirut@hawassa.fisher.et',
      phone: '+251911300001',
      license: 'FSH-HAW-2024-001',
      status: 'VALID',
      expiry: '2026-12-31',
      zone: 'Lake Hawassa – Resort Bay',
      boat: 'Hawassa Pearl',
      reg: 'HW-2024-001',
      cap: 200,
      region: 'HAWASSA',
    ...
    {
      name: 'Samuel Girma',
      email: 'samuel@hawassa.fisher.et',
      phone: '+251911300002',
      license: 'FSH-HAW-2024-002',
      status: 'VALID',
      expiry: '2026-10-31',
      zone: 'Lake Hawassa – East Shore',
      boat: 'Sidama Catch',
      reg: 'HW-2024-002',
      cap: 170,
      region: 'HAWASSA',
  ...
  const buyerData = [
    ...
    {
      name: 'Rahel Bekele',
      email: 'rahel@buyer.et',
      phone: '+251922221004',
      location: 'Bahir Dar',
    },
    {
      name: 'Dawit Molla',
      email: 'dawitmolla@buyer.et',
      phone: '+251922221005',
      location: 'Woreta',
    },
  ];
  ...
  const historicalCatches = [
    ...
    },
    {
      ...
      reason: 'Catch submitted from a prohibited zone (Core Protected Area).',
    },
    {
      email: 'girma@fisher.et',
      species: 'Nile Perch',
    ...
    },
    {
      ...
      time: '06:30',
      status: 'REJECTED',
      reason: 'Quantity inconsistent with number of fish reported.',
    },
    {
      email: 'tesfaye@fisher.et',
      species: 'Tilapia',
    ...
    data: [
      {
        ...
        message: 'Monthly Tilapia quota has reached 75%.',
        severity: 'WARNING',
        isRead: false,
      ...
      },
      {
        ...
        message: 'Fisher Kebede Molla — prohibited zone catch rejected.',
        severity: 'CRITICAL',
        isRead: false,
  ...
  await prisma.notification.createMany({
    data: [
      {
        userId: fisherUserIds['tesfaye@fisher.et'],
        type: 'CATCH_APPROVED',
        title: 'Catch Approved',
        message: 'Your catch has been approved and listed.',
        isRead: true,
        createdAt: daysAgo(7),
      },
      {
        userId: fisherUserIds['kebede@fisher.et'],
        type: 'CATCH_REJECTED',
        title: 'Catch Not Approved',
        message: 'Prohibited zone catch rejected.',
        isRead: false,
        createdAt: daysAgo(2),
      },
    ],
  ...
  const activeTrip = await prisma.boatTrip.create({
    data: {
      boatId: tesfayeBoatId,
      fisherId: tesfayeFisherId,
      startedAt: daysAgo(0),
      status: 'ACTIVE',
    },
  });
  await prisma.boatTrip.create({
    data: {
      boatId: boatIds[1],
      fisherId: fisherIds['abebe@fisher.et'],
      startedAt: daysAgo(1),
      endedAt: daysAgo(1),
      status: 'COMPLETED',
    },
  ...
  for (const [species, base] of Object.entries(speciesPrices)) {
    for (let d = 0; d < 7; d++) {
      await prisma.priceHistory.create({
        data: {
          species,
          pricePerKg: base + (Math.random() - 0.5) * 15,
  ...
  await prisma.zoneSeasonRule.createMany({
    data: [
      {
        zoneId: zoneIds['Lake Tana – West Zone (Mecha)'],
        species: 'Tilapia',
        seasonStart: '03-01',
        seasonEnd: '06-30',
        ruleType: 'LIMIT',
        maxKg: 500,
        notes: 'Spawning season reduced catch limit',
      },
      {
        zoneId: zoneIds['Zege Peninsula Waters'],
        species: 'Nile Perch',
        seasonStart: '01-01',
        seasonEnd: '12-31',
        ruleType: 'CLOSED',
        notes: 'Ecotourism protection',
      },
      {
        zoneId: zoneIds['Lake Tana – North Zone (Gorgora)'],
        species: 'Catfish',
        seasonStart: '07-01',
        seasonEnd: '12-31',
        ruleType: 'OPEN',
        notes: 'Peak season open fishing',
      },
    ],
  });
  ...
  await prisma.violation.createMany({
    data: [
      {
        referenceId: 'VIO-20250521-0001',
        fisherId: fisherIds['kebede@fisher.et'],
        zoneId: zoneIds['Lake Tana – Core Protected Area'],
        type: 'ZONE_VIOLATION',
        severity: 'CRITICAL',
        description: 'Catch from Core Protected Area.',
        status: 'RESOLVED',
        fineAmount: 2500,
        fineStatus: 'PENDING',
        reportedByUserId: inspectorIds['solomon@fisheries.gov.et'],
        createdAt: daysAgo(2),
      },
      {
        referenceId: 'VIO-20250521-0002',
        fisherId: fisherIds['hailu@fisher.et'],
        type: 'LICENSE_EXPIRED',
        severity: 'HIGH',
        description: 'Fishing with expired license.',
        status: 'OPEN',
        reportedByUserId: inspectorIds['hanna@fisheries.gov.et'],
        createdAt: daysAgo(5),
      },
      {
        referenceId: 'VIO-20250521-0003',
        fisherId: fisherIds['worku@fisher.et'],
        type: 'QUOTA_EVASION',
        severity: 'MEDIUM',
        description: 'Under-reported catch quantity.',
        status: 'UNDER_REVIEW',
        fineAmount: 800,
        fineStatus: 'PENDING',
  ...
  await prisma.inspection.createMany({
    data: [
      {
        referenceId: 'INS-20250521-0001',
        inspectorId: inspectorIds['solomon@fisheries.gov.et'],
        fisherId: fisherIds['kebede@fisher.et'],
        zoneId: zoneIds['Lake Tana – West Zone (Mecha)'],
        title: 'Quota spot check — West Zone',
        instructions: 'Verify catch logs.',
        status: 'ASSIGNED',
        scheduledAt: new Date(Date.now() + 7200000),
      },
      {
        referenceId: 'INS-20250521-0002',
        inspectorId: inspectorIds['hanna@fisheries.gov.et'],
        fisherId: fisherIds['hailu@fisher.et'],
        zoneId: zoneIds['Lake Tana – North Zone (Gorgora)'],
        title: 'License renewal verification',
        status: 'IN_PROGRESS',
  ...
  await prisma.auditLog.create({
    data: {
      ...
      entityType: 'catch',
      entityId: 1,
      payloadJson: JSON.stringify({ reference_id: 'CATCH-demo-0001' }),
      ip: '127.0.0.1',
      createdAt: daysAgo(7),
    },
  });
  await prisma.domainEvent.create({
    data: {
      eventType: 'catch.submitted',
      payloadJson: JSON.stringify({ species: 'Tilapia' }),
      createdAt: daysAgo(0),
    },
  });
